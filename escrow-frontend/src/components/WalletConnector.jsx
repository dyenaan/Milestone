  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center">
      ...
      <p className="text-gray-600 mb-6">
        Connect your wallet to interact with the Aptos Escrow system.
      ...
      <button
        ...
        disabled={connecting}
        className={`w-full bg-blue-600 text-white py-3 px-6 rounded-lg shadow-md hover:bg-blue-700 transition flex items-center justify-center font-bold ${
