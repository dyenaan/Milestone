script {
    ...
    fun assign_reviewers_main(sender: signer, client: address, milestone_index: u64, reviewer1: address, reviewer2: address, reviewer3: address, reviewer4: address, reviewer5: address) {
